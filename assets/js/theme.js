  ...
  var Countdown =
    ...
    (function() {
      function Countdown(element) {
        ...
        this.daysText =
          $element.attr(Selector.DAYS_TEXT_ATTR) || Default.DAYS_TEXT;
        this.countdownText = "%D " + this.daysText + " %H:%M:%S";
        this.dateFormat =
          $element.attr(Selector.DATE_FORMAT_ATTR) || this.countdownText;
        this.fallback =
          $element.attr(Selector.DATE_FALLBACK_ATTR) || Default.ELAPSED;
        this.initCountdown();
      } // getters
...
$("[data-isotope-filter]").on("click", function(e) {
  ...
  var isotopeId =
    ...
    $(e.target)
      .closest("[data-isotope-id]")
      .attr("data-isotope-id") +
    '"]';
...
var mrMaps = (function($) {
    ...
    (function() {
      ...
      _proto2.initMap = function initMap() {
        ...
        var latlong =
          typeof mapInstance.attr("data-latlong") !== typeof undefined
            ...
            : false;
        var latitude = latlong
          ? parseFloat(latlong.substr(0, latlong.indexOf(",")))
          : false;
        var longitude = latlong
          ? parseFloat(latlong.substr(latlong.indexOf(",") + 1))
          : false;
        ...
        try {
          mapAo.styles = this.styleElement.length
            ? JSON.parse(this.styleElement.html().trim())
            : undefined;
        } catch (error) {
        ...
        if (
          ...
          throw new Error(
            "No valid address or latitude/longitude pair provided for map."
          );
        }
      };

      _proto2.geocodeAddress = function geocodeAddress(
        address,
        callback,
        thisMap,
        args
        ...
        this.geocoder.geocode(
          ...
          function(results, status) {
            if (status !== google.maps.GeocoderStatus.OK) {
              throw new Error(
                'There was a problem geocoding the address "' + address + '".'
              );
            } else {
      ...
      _proto2.createMarkers = function createMarkers() {
        ...
        this.markerElements.each(function(index, marker) {
          ...
          markerAo.icon =
            typeof $marker.attr("data-marker-image") !== typeof undefined
              ? {
          ...
          if (markerLatLng) {
            ...
            gMarker = null;
            throw new Error(
              "Invalid data-address or data-latlong provided for marker " +
                (index + 1)
            );
          }
        });
  ...
  if (
    ...
    if ($("[data-maps-api-key]").length) {
      var apiKey =
        $("[data-maps-api-key]:first").attr("data-maps-api-key") || "";
      ...
      _proto3.initWatcher = function initWatcher(element) {
        ...
        watcher.stateChange(function() {
          ...
          $element.toggleClass(
            ...
            (watcher.isFullyInViewport || watcher.isAboveViewport) &&
              _this4.stickBottom
          );
...
$(document).ready(function() {
  $(".video-cover .video-play-icon").on(
    "click touchstart",
